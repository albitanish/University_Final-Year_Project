...
byte sck = 14;     // GPIO 14, D5
byte miso = 12;  // GPIO 12, D6
byte mosi = 13;  // GPIO 13, D7
byte ss = 15;      // GPIO 15, D8
int gdo0 = 5;     // GPIO 5, D1
int gdo2 = 4;     // GPIO 4, D2

byte sendingBuffer[BUFFERSIZE] = {0};
byte receivingBuffer[BUFFERSIZE] = {0};
